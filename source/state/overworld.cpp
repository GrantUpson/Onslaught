...
void Overworld::OnEnter() {
    ...
    tiles.emplace_back(Forest, 0, 7.0f, 0.0f); //Grass
    tiles.emplace_back(Forest, 0, 1.0f, 3.0f); //Rock
    tiles.emplace_back(Forest, 0, 9.0f, 6.0f); //Grass Tuft
    tiles.emplace_back(Forest, 0, 17.0f, 4.0f); //Mushroom
    tiles.emplace_back(Forest, 0, 15.0f, 10.0f); //Flower
